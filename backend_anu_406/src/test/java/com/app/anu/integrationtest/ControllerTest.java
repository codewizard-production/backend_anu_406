package com.app.anu.integrationtest;
...
class ControllerTest {
  ...
  void  testRetrieveMetadataDocument() {
    ...
    assertNotNull(n);
    assertEquals("anu", n.getAttribute("Namespace"));
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM anu.PetService");
    jdbcTemplate.execute("DELETE FROM anu.PetOwner");
    jdbcTemplate.execute("DELETE FROM anu.PetCareCenter");
    jdbcTemplate.execute("DELETE FROM anu.Manager");
    jdbcTemplate.execute("DELETE FROM anu.Document");
    jdbcTemplate.execute("DELETE FROM anu.Pet");
     jdbcTemplate.execute("DELETE FROM anu.PetCareCenterServices");
     jdbcTemplate.execute("DELETE FROM anu.PetCareCenterBusinessHours");
     jdbcTemplate.execute("DELETE FROM anu.PetOwnerPets");
     jdbcTemplate.execute("DELETE FROM anu.PetCareCenterImages");
     jdbcTemplate.execute("DELETE FROM anu.PetCareCenterPets");
